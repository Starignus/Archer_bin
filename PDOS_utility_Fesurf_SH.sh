...
mv ${SYSTEM_PATH}.pdos_atm#21\(* S_states
cd S_states

sum_states.py -s "*S*wfc*" -o ../$SCF_out -xr -100 100
mv sum_dos.out S_tot_LA.dat

sum_states.py -s "*S*wfc*s*" -o ../$SCF_out -xr -100 100
mv sum_dos.out S_s_tot_LA.dat

sum_states.py -s "*S*wfc*p*" -o ../$SCF_out -xr -100 100
mv sum_dos.out S_p_tot_LA.dat

cat S_tot_LA.dat | awk '{print $1, $2, $3*(-1)}' |  sed '1d' > S_tot_LA_shifted.dat
cat S_s_tot_LA.dat | awk '{print $1, $2, $3*(-1)}' |  sed '1d' > S_s_tot_LA_shifted.dat
cat S_p_tot_LA.dat | awk '{print $1, $2, $3*(-1)}' |  sed '1d' > S_p_tot_LA_shifted.dat
cd ..

sum_states.py -s "*H*wfc*" -o $SCF_out -xr -100 100
mv sum_dos.out H_tot_LA.dat

cat H_tot_LA.dat | awk '{print $1, $2, $3*(-1)}' |  sed '1d' > H_s_tot_LA_shifted.dat
cd ..
